...
class RoadmapGen():
	...
	@agent
	def career_researcher(self) -> Agent:
		return Agent(
			config=self.agents_config['career_researcher'],
		)
	...
	@agent
	def react_flow_roadmap_generator(self) -> Agent:
		return Agent(
			config=self.agents_config['react_flow_roadmap_generator'],
		)
